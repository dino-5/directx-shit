...
void DescriptorHeap::init(ID3D12Device* device, UINT numDesc, DescriptorHeapType type)
{
    ...
    cbvHeapDesc.Flags = (type==DescriptorHeapType::CBV_SRV_UAV) 
...
void DescriptorHeap::createCBV(ID3D12Device* device,
                               Resource& res,
...
void DescriptorHeap::createUAV(ID3D12Device* device,
                               Resource& res,
...
void DescriptorHeap::createDSV(ID3D12Device* device,
                               Resource& res,
...
{
    DescriptorHeapManager::CreateSRVHeap(450);
}
};
