...
public:
	Resource() = default;
	Resource(DXGI_FORMAT format, uint width, uint height,uint depthOrArraySize, uint dimension, ResourceFlags flag, 
	...
	void CreateViews(ResourceDescriptorFlags descriptors);
